    ...
    <div class="row">
                ...
                <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        <form>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="{{ route('admin.user.edit', $user->id) }}" class="btn btn-primary text-white"
                                        type="submit"><i class="bi bi-pencil mx-1"></i>Edit</a>
                                    <a href="/admin/user" class="btn btn-info text-white"><i
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.user.changePassword', $user->id) }}">
                        @csrf
