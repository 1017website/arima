            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title">Bug List</h4>
                        <a class="btn btn-primary" href="/admin/bug/create">
                            <i class="bi bi-plus-circle mx-1"></i>Add New Bug
                        </a>
                    </div>
                    @if (count($bug) > 0)
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <img class="object-contain items-center"
                                                    style="width:8rem;height:8rem;object-fit:cover"
                                                    src="{{ asset('admin-assets/img/no-photo.png') }}">
                                                @endif
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-right">
                                            <a href="{{ route('admin.bug.show', $c->id) }}"><i
                                                    class="now-ui-icons ui-1_zoom-bold"></i></a>
                                            <a href="{{ route('admin.bug.edit', $c->id) }}"><i
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content" style="border-radius:1.3rem;border:none">
                                                        ...
                                                        <div class="modal-footer" style="border-top:none">
                                                            ...
                                                            <form action="{{ route('admin.bug.destroy', $c->id) }}"
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-end pt-4">
                                    @if ($bug->currentPage() > 1)
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $bug->previousPageUrl() }}" tabindex="-1"
                                            style="color:#dc3545">
                                    ...
                                    @for ($i = 1; $i <= $bug->lastPage(); $i++)
                                        <li class="page-item {{ $i == $bug->currentPage() ? 'active' : '' }}">
                                            <a class="page-link" href="{{ $bug->url($i) }}"
                                                style="color:#dc3545;{{ $i == $bug->currentPage() ? 'color:white;background-color:#dc3545;border:#dc3545' : '' }}">
                                                {{ $i }}
                                            </a>
                                        </li>
                                        @endfor

                                        @if ($bug->currentPage() < $bug->lastPage())
                                            <li class="page-item">
                                                <a class="page-link" href="{{ $bug->nextPageUrl() }}"
                                                    style="color:#dc3545">
