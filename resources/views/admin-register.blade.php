...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .auth-page { position: relative; min-height: 100svh; display: grid; place-items: center; padding: 40px 20px; }
        .auth-card {
            width: min(100%, 500px);
            padding: 34px;
...
<body>
    <main class="auth-page">
        <section class="auth-card">
            ...
            <p>Buat akun baru untuk mengelola konten ARIMA.</p>
            ...
            <form method="POST" action="{{ route('admin.register') }}">
                ...
                <div class="actions">
                    ...
                    <a class="login-link" href="{{ route('admin.login') }}">Login</a>
                </div>
            </form>
        </section>
    </main>
