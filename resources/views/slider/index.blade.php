            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        @if($sliderCount < 3)
                            <a class="btn btn-primary" href="/admin/slider/create">
                                <i class="bi bi-plus-circle mx-1"></i>Add New Slider
                            </a>
                        @endif
                    </div>
                    @if (count($slider) > 0)
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            {{ ($slider->currentPage() - 1) * $slider->perPage() +
                                            $loop->iteration }}
                                        </td>
                                        <td>
                                            {{$c->name}}
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                @else
                                                    <img class="object-contain items-center" style="width:8rem;height:8rem;object-fit:cover" src="{{ asset('admin-assets/img/no-photo.png') }}">
                                                @endif
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-right">
                                            <a href="{{ route('admin.slider.show', $c->id) }}"><i
                                                    class="now-ui-icons ui-1_zoom-bold"></i></a>
                                            <a href="{{ route('admin.slider.edit', $c->id) }}"><i
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content" style="border-radius:1.3rem;border:none">
                                                        ...
                                                        <div class="modal-footer" style="border-top:none">
                                                            ...
                                                            <form action="{{ route('admin.slider.destroy', $c->id) }}"
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-end pt-4">
                                    ...
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $slider->previousPageUrl() }}" tabindex="-1"
                                            style="color:#dc3545">
                                    ...
                                    @for ($i = 1; $i <= $slider->lastPage(); $i++)
                                        <li class="page-item {{ $i == $slider->currentPage() ? 'active' : '' }}">
                                            <a class="page-link" href="{{ $slider->url($i) }}"
                                                style="color:#dc3545;{{ $i == $slider->currentPage() ? 'color:white;background-color:#dc3545;border:#dc3545' : '' }}">
                                                {{ $i }}
                                            </a>
                                        </li>
                                        @endfor
