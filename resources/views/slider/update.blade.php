                        ...
                        <form method="POST" action="{{ route('admin.slider.update',$slider->id)}}"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Detail</label>
                                        <textarea rows="10" cols="80" class="form-control @error('detail') is-invalid @enderror" id="detail" name="detail"
                                            placeholder="Here can be your description"
                                            required>{{$slider->detail}}</textarea>
                                        @error('detail')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="/admin/slider" class="btn btn-info text-white"><i
