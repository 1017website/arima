        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="card-title" style="font-weight:bold">Edit Content Factory</h4>
                        ...
                        <form method="POST" action="{{ route('admin.factory.update',$factory->id)}}"
                                ...
                                <div class="col-md-12 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" name="title"
                                            ...
                                            placeholder="Title" value="{{$factory->title}}" required>
                                        @error('title')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="@error('description') is-invalid @enderror" name="description"
                                            style="display:none;">{{$factory->description}}</textarea>
                                        @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="@error('description_eng') is-invalid @enderror"
                                            ...
                                            style="display:none;">{{$factory->description_eng}}</textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="@error('list_type') is-invalid @enderror" name="list_type"
                                            style="display:none;">{{$factory->list_type}}</textarea>
                                        @error('list_type')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="/admin/factory" class="btn btn-info text-white"><i
...
<script>
    @foreach(['description', 'description_eng', 'list_type'] as $fieldName)
        ClassicEditor
            ...
            .then(editor => {
                editor.setData(`{!! $factory[$fieldName] !!}`);
