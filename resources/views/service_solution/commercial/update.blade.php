        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="card-title" style="font-weight:bold">Edit Content Commercial</h4>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('admin.commercial.update',$commercial->id)}}"
                                ...
                                <div class="col-md-12 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" name="title"
                                            ...
                                            placeholder="Title" value="{{$commercial->title}}" required>
                                        @error('title')
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="/admin/commercial" class="btn btn-info text-white"><i
