        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="card-title" style="font-weight:bold">Content Cleaning Service</h4>
                    ...
                    <div class="card-body">
                        ...
                        <form id="#form">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" name="title" class="form-control"
                                            placeholder="title" value="{{$cleaning->title}}" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="grid grid-cols-6">
                                            ...
                                            <img id="image_display" class="object-cover"
                                                ...
                                                src="{{asset($cleaning->background)}}" alt="image description">
                            ...
                            {{-- <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <div class="form-control" disabled>{!! $cleaning->list_type !!}</div>
                                        </div>
                                    </div>
                                </div>
                            </div> --}}
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="{{ route('admin.cleaning.edit', $cleaning->id) }}"
