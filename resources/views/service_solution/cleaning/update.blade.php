        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="card-title" style="font-weight:bold">Edit Content Cleaning Service</h4>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('admin.cleaning.update',$cleaning->id)}}"
                                ...
                                <div class="col-md-12 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" name="title"
                                            ...
                                            placeholder="Title" value="{{$cleaning->title}}" required>
                                        @error('title')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="@error('description') is-invalid @enderror" name="description"
                                            style="display:none;">{{$cleaning->description}}</textarea>
                                        @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="@error('description_eng') is-invalid @enderror"
                                            ...
                                            style="display:none;">{{$cleaning->description_eng}}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="/admin/cleaning" class="btn btn-info text-white"><i
...
<script>
    @foreach(['description', 'description_eng'] as $fieldName)
        ClassicEditor
            ...
            .then(editor => {
                editor.setData(`{!! $cleaning[$fieldName] !!}`);
