        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="card-title" style="font-weight:bold">Edit Content Residential</h4>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('admin.residential.update',$residential->id)}}"
                                ...
                                <div class="col-md-12 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" name="title"
                                            ...
                                            placeholder="Title" value="{{$residential->title}}" required>
                                        @error('title')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="grid grid-cols-6">
                                            ...
                                            <img id="image_display" class="object-contain items-center"
                                                ...
                                                src="{{asset($residential->background)}}">
                                            @else
                                            <img id="image_display" class="object-contain items-center"
                                                style="width:10rem;height:10rem;object-fit:cover"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="@error('description') is-invalid @enderror" name="description"
                                            style="display:none;">{{$residential->description}}</textarea>
                                        @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="@error('description_eng') is-invalid @enderror"
                                            ...
                                            style="display:none;">{{$residential->description_eng}}</textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="@error('list_type') is-invalid @enderror" name="list_type"
                                            style="display:none;">{{$residential->list_type}}</textarea>
                                        @error('list_type')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="/admin/residential" class="btn btn-info text-white"><i
...
<script>
    @foreach(['description', 'description_eng', 'list_type'] as $fieldName)
        ClassicEditor
            ...
            .then(editor => {
                editor.setData(`{!! $residential[$fieldName] !!}`);
