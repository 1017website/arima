        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="card-title" style="font-weight:bold">Content Fumigation</h4>
                    ...
                    <div class="card-body">
                        ...
                        <form id="#form">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" name="title" class="form-control"
                                            placeholder="title" value="{{$fumigation->title}}" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="grid grid-cols-6">
                                            ...
                                            <img id="image_display" class="object-cover"
                                                ...
                                                src="{{asset($fumigation->header_image)}}" alt="image description">
                                            @else
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="{{ route('admin.fumigation.edit', $fumigation->id) }}"
